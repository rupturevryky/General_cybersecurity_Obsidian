...
> [!note] Назначение
> Справочник команд из исходных конспектов. Перед выполнением проверяйте синтаксис через `man`, `--help` или документацию конкретной версии. Команды оценки безопасности применяйте только в разрешённой лабораторной среде.
...
[[01 Основы/Linux/Конфигурация Linux#Управление пакетами|Управление пакетами Linux]]
