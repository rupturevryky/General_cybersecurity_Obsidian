...
verified_against: https://github.com/Dheerajmadhukar/back-me-up
---

> [!warning] Наследуемый инструмент
> Проект устанавливает сторонние средства через shell-скрипт. Не используйте его как базовую установку курса; команды допускаются только в одноразовой VM после чтения скрипта.
