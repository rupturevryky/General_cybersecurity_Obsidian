...
> Aqua Security официально сообщает, что kube-hunter больше активно не развивается, и рекомендует Trivy для проверки Kubernetes misconfiguration и KBOM. Этот конспект сохранён как исторический материал; для новых лабораторных работ переходите к [[Trivy]].
