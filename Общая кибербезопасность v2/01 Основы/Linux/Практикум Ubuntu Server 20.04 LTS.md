# Практикум Ubuntu Server 20.04 LTS

> [!abstract] Цель
> Последовательно отработать установку, первичную настройку, управление пользователями, сетью, SSH, хранилищем, журналами и cron.
