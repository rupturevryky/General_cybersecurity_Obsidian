...
((c >> 0) & 1) == 1
```
> Пример использования: [[04 NoSQL injection#Lab Exploiting NoSQL injection to extract data]]
...
...
```
> Пример: [[04 NoSQL injection#Умный метод - битовый подбор по ASCII]]
...
7. Переводим строку в человеческий вид. Можно использовать скрипт: 
      ...
      ![[03 Практика SQL injection#Скрипт перевода двоичной ASCII строки в символы ( ASCII_to_chars )]]
