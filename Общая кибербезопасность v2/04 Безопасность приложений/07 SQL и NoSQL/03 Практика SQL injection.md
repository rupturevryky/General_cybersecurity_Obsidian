...
> Пример: [[03 Практика SQL injection#Lab Blind SQL injection with conditional responses]]
...
![[03 Практика SQL injection#Скрипт перевода двоичной ASCII строки в символы]]
...
Подбираем удачную кодировку и смотрим ответ ([To HTML Entity - CyberChef]([To HTML Entity - CyberChef](https://gchq.github.io/CyberChef/#recipe=To_HTML_Entity\(true,'Named%20entities'\)&input=U0VMRUNUIE5VTEw7&ieol=CRLF&oeol=CR))):
