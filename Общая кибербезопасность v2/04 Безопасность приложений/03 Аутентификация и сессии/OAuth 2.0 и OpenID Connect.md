...
4. `scope`
   ...
   > Используется для указания, к какому подмножеству данных пользователя клиентское приложение хочет получить доступ. Обратите внимание, что это могут быть пользовательские области, заданные провайдером OAuth, или стандартизированные области, определённые спецификацией [[OAuth 2.0 и OpenID Connect#OpenID Connect|OpenID Connect]].
   > 
5. `state`
...
Лаба: [[OAuth 2.0 и OpenID Connect#Лабораторные#Lab Authentication bypass via OAuth implicit flow|Authentication bypass via OAuth implicit flow]].
...
Лаба: [[OAuth 2.0 и OpenID Connect#Lab Forced OAuth profile linking|Forced OAuth profile linking]]
