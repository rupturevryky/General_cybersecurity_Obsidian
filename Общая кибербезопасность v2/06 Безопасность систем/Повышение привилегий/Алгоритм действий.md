...
[[03 Оценка защищённости/Сканирование уязвимостей/Инструментарий|Инструментарий сканирования уязвимостей]]
# Linux
...
Дополнительный материал по инвентаризации системы: [[01 Основы/Linux/Конфигурация Linux#Информация о системе|Информация о Linux-системе]].
