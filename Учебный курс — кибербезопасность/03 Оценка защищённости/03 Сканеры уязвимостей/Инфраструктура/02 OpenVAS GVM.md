...
verified_against: https://greenbone.github.io/docs/latest/22.4/kali/index.html
---

> [!warning] Версии GVM зависят от дистрибутива
> Старое имя `openvas` заменено стеком GVM. Для Kali используйте `gvm`, `gvm-setup`, `gvm-check-setup` и документацию своего выпуска.
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/openVAS.png]]
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629101722.png]]
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629101733.png]]
Проверьте запущен ли **Redis**:
```
sudo systemctl status redis-server@openvas.service
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629101823.png]]
Запустите настройку **gvm**:
```
sudo gvm-setup
```
Команда должна создать пользователя для **openvas/gvm**. Сохраните этот пароль!
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629101900.png]]
Проверьте правильность настройки:
```
sudo gvm-check-setup
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629101934.png]]
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629102010.png]]
...
sudo systemctl status gvmd ospd-openvas
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629102054.png]]
Включите помощника по безопасности **greenbone**:
```
sudo systemctl enable greenbone-security-assistant
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629102116.png]]
...
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629103531.png]]
...
docker ps
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629103944.png]]
...
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629104042.png]]
...
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629102532.png]]
...
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629102754.png]]
Нажмите кнопку воспроизведения, чтобы начать сканирование.
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629102808.png]]
...
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629102831.png]]
...
openvas-start
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629105208.png]]
...
load openvas
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629105321.png]]
...
openvas_help
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629105355.png]]
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629105447.png]]
...
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629105632.png]]
...
openvas_config_list
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629105821.png]]
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629110221.png]]
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629110325.png]]
...
openvas_task_list
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629110357.png]]
...
openvas_report_list
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629110503.png]]
Теперь можно выбрать, в каком формате экспортировать отчет:
```
openvas_format_list
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629110520.png]]
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/03 Сканеры уязвимостей/Инфраструктура/assets/Pasted image 20240629110558.png]]
