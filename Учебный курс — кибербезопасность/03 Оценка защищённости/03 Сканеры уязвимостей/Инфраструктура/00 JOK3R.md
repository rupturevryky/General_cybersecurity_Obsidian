...
verified_against: https://github.com/koutto/jok3r
---

> [!warning] Наследуемая платформа
> Старый контейнер использует `--net=host`, X11 и большой набор зависимостей. Самостоятельный запуск в рамках курса не предусмотрен; заметка сохранена для исторического обзора возможностей инструмента.
