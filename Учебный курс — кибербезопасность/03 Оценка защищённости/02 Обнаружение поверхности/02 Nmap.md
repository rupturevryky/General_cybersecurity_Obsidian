...
> [!note] Актуальный синтаксис
> Проверено по официальному Nmap Reference Guide. Регистр важен: отключение host discovery записывается `-Pn`, а `-sn` отключает сканирование портов. Перед практикой проверьте установленную сборку командой `nmap --version`.
...
![[Учебный курс — кибербезопасность/03 Оценка защищённости/02 Обнаружение поверхности/assets/HOST_DISCOVERY.png]]
![[Учебный курс — кибербезопасность/03 Оценка защищённости/02 Обнаружение поверхности/01 Основы сетевого сканирования#Типы сканирований и протоколы]]
...
## SCAN TECHNIQUES
![[Учебный курс — кибербезопасность/03 Оценка защищённости/02 Обнаружение поверхности/assets/SCAN_TECHNIQUES.png]]
...
![[Учебный курс — кибербезопасность/03 Оценка защищённости/02 Обнаружение поверхности/assets/Pasted image 20240630092157.png]]![[Учебный курс — кибербезопасность/03 Оценка защищённости/02 Обнаружение поверхности/assets/Pasted image 20240630092204.png]]
...
2. Второй способ - запуск **конкретного скрипта**, скрипты которые устанавливаются вместе с nmap по умолчанию лежат в папке: `usr/share/nmap/scripts`
    ...
    ![[Учебный курс — кибербезопасность/03 Оценка защищённости/02 Обнаружение поверхности/assets/Список скриптов nmap.png]]
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/02 Обнаружение поверхности/assets/Pasted image 20240705220752.png]]
### nbstat
...
```
![[Учебный курс — кибербезопасность/03 Оценка защищённости/02 Обнаружение поверхности/assets/Pasted image 20240705220801.png]]
