...
# Фингерпринтинг по MurmurHash

**Fingerprint** — короткий технический признак для поиска похожих объектов. MurmurHash — быстрый не криптографический хеш: коллизии ожидаемы, а небольшое изменение входа полностью меняет значение. Совпадение favicon hash помогает сформировать кандидатов, но не доказывает одинаковую технологию, владельца или уязвимость.

Фиксируйте точные байты, способ кодирования и вариант алгоритма: разные инструменты могут хешировать содержимое файла, base64-представление или нормализованный ввод и получать разные числа.
