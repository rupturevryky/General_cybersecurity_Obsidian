...
# Метаданные опубликованных документов и FOCA

**Метаданные** описывают документ: автора, программу, время, шаблон, пути, принтер или организационные поля. Они помогают строить гипотезы о технологиях и именах, но могут быть устаревшими, унаследованными из шаблона или намеренно изменёнными.

## Безопасная обработка

- скачивайте только разрешённые публичные документы;
- сохраняйте URL, время, HTTP-заголовки и SHA-256;
- не открывайте недоверенный активный документ в рабочей среде;
- извлекайте метаданные в изолированной среде внешней платформы;
- не выполняйте macros, embedded objects и внешние ссылки;
- минимизируйте персональные данные в отчёте.

FOCA автоматизирует поиск документов и извлечение метаданных. Результат инструмента остаётся наблюдением: автора, hostname или путь необходимо подтверждать независимо.
...
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/03 Метаданные и документы/assets/Pasted image 20240707104553.png]]
...
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/03 Метаданные и документы/assets/Pasted image 20240707105006.png]]
