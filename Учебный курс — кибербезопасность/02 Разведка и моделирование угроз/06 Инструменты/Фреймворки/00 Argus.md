...
verified_against: https://github.com/jasonxtn/argus
---

# Argus

> [!note] Актуальный Argus Recon
> Текущая версия имеет пакетную точку входа: `argus` либо `python -m argus`. Старый запуск `python argus.py` больше не соответствует структуре официального репозитория.

```bash
python3 -m venv .venv
source .venv/bin/activate
python3 -m pip install argus-recon
argus
```

Для проверки исходников без установки используйте `python3 -m argus`. Команды `run` и `runall` могут выполнять активные сетевые проверки — сначала задайте и проверьте scope внутри Argus.
...
IP-адрес сайта.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180050.png]]  
Открытые порты.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180106.png]]
Подробнейший отчёт из WHOIS Lookup.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180119.png]]
Ссылки на слепки сайта из веб архива.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180128.png]]
CMS сайта.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180140.png]]
Файлы которые имеются на сайте.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180159.png]]
Поиск электронной почты.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180210.png]]
Ссылки на социальные сети, какие технологии используются(например какой веб сервер).  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180221.png]]
Какие имеются меры безопасности на сайте.  
 ![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180242.png]] 
Версия SSL сертификата.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180254.png]]
И пожалуй самое вкусное это перечень подобранных CVE под службы запущенные на сайте.  
![[Учебный курс — кибербезопасность/02 Разведка и моделирование угроз/06 Инструменты/Фреймворки/assets/Pasted image 20250130180306.png]]
