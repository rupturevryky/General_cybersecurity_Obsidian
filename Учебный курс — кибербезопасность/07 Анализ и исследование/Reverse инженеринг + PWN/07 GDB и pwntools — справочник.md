...
verified_against: https://docs.pwntools.com/en/stable/install.html
---

[[Учебный курс — кибербезопасность/10 Справочники/01 Каталог инструментов#Реверс-инжиниринг|Инструменты ревёрса]]

> [!note] Изолированная Python-среда
> Pwntools устанавливайте в venv/pipx согласно поддерживаемой версии Python. Не изменяйте системный Python через глобальный pip.

# GDB-PEDA — команды проверки буфера и адресов

> [!note] Статус PEDA
> PEDA сохранён как исторический интерфейс к GDB: официальный репозиторий всё ещё доступен, но конспект не следует считать универсальным для современных GDB и Python. Перед заданием проверяйте команды в выданной среде внешней платформы. Для pwntools используйте поддерживаемую Python 3-версию и сверяйтесь с официальной документацией.
