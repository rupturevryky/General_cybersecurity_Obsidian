...
![[Учебный курс — кибербезопасность/01 Основы/Linux/Передача файлов/assets/Pasted image 20240715121408.png]]
...
Далее вам будет предложено ввести парольную фразу для ключа. Это опциональная парольная фраза, которую можно использовать для шифрования файла закрытого ключа на диске. ![[Учебный курс — кибербезопасность/01 Основы/Linux/Передача файлов/assets/Pasted image 20240715125533.png]]
...
```
![[Учебный курс — кибербезопасность/01 Основы/Linux/Передача файлов/assets/Pasted image 20240715130400.png]]
...
Затем утилита проведет сканирование локальной учетной записи для поиска ранее созданного ключа `id_rsa.pub`. Когда ключ будет найден, вам будет предложено ввести пароль учетной записи удаленного пользователя:![[Учебный курс — кибербезопасность/01 Основы/Linux/Передача файлов/assets/Pasted image 20240715130452.png]]
...
Вы получите следующий результат:![[Учебный курс — кибербезопасность/01 Основы/Linux/Передача файлов/assets/Pasted image 20240715130558.png]]
