...
Когда в будущем выполняется запрос на тот же статический ресурс, кэш напрямую передаёт сохранённую копию ответа пользователю (это называется кэш-хитом).![[Учебный курс — кибербезопасность/04 Безопасность приложений/05 Серверная безопасность/Кэширование/assets/Pasted image 20251224184455.png]]
