...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194130.png]]
...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194212.png]]
...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194324.png]]
...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194420.png]]
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194429.png]]
...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194509.png]]
...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194621.png]]
...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194931.png]]
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614194936.png]]
...
1. Удобный просмотр GraphQL запросов как в GraphQL Raider ![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614195220.png]]
2. Раздел, который сохраняет все GraphQL запросы![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614195248.png]]
3. Раздел, который как альтаир, запрашивает схему через интроспекцию, которую потом можно будет просмотреть и отправить в другие инструменты, причём обратите, что отправить можно в разных формах![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614195315.png]]![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614195318.png]]
4. Раздел для атаки![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614195333.png]]
5. И другие функции в контектном меню, особенное внимание на то, что GraphQL-запрос можно отправить в Repeater как обычный GraphQL-pfпрос в бурпе, так и с методом GET и с методом POST, имеющим другие Content-Type!![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614195358.png]]
...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614195744.png]]
...
Также можно подставить `/%761` вначале роутов.
...
## [[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/01 Основы API#GraphQL|Введение]]

## Система типов 
Давайте ещё раз посмотрим на картинку с SDL, и пройдёмся по ней:
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614201757.png]]
### **Скалярные типы**
...
### Тип Object
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614201827.png]]
...
На схеме показаны типы `Todo`, `Query` и `Mutation`. `Query` и `Mutation` являются корневыми типами операций; для схемы обязателен `Query`, а `Mutation` добавляется, если API поддерживает изменение данных.
...
Пример Query запроса:![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614201909.png]]
Пример ответа сервера в JSON:![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614201918.png]]
...
Пример запроса(с параметрами) и ответа:![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614202005.png]]
...
![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614202113.png]]
...
Пример запроса интроспекции и ответа на него:![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614202241.png]]
...
Также запросы могут иметь параметр `operationName` , в котором описывается что это за операция. Помимо неё есть необязательное название query,mutation,subscription запроса:![[Учебный курс — кибербезопасность/04 Безопасность приложений/06 API/assets/Pasted image 20240614202303.png]]
...
Также иногда существует возможность достучаться до метаданных приложения через эндпоинт `/%761/metadata`. Если получится получить доступ к этой странице, то можно будет получить все данные о приложении и др.

##### **Bulk SQL-queries**

Для версии 1.3.3 возможно прозксплуатировать bulk выполнение mutations с помощью кастомного запроса на /%761/query для выполнения сырых SQL запросов:)
