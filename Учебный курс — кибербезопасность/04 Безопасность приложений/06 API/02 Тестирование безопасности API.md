...
Если вы определили конечную точку для ресурса, обязательно изучите базовый путь. Например, если вы определили конечную точку ресурса `/api/swagger/%761/users/123`, то следует исследовать следующие пути: 
