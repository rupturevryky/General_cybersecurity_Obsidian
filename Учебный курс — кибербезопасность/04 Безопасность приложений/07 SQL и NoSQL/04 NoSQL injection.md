...
((c >> 0) & 1) == 1
```
> Пример использования: [[Учебный курс — кибербезопасность/04 Безопасность приложений/07 SQL и NoSQL/04 NoSQL injection#Lab: Exploiting NoSQL injection to extract data|Lab: Exploiting NoSQL injection to extract data]]
...
...
```
> Пример: [[Учебный курс — кибербезопасность/04 Безопасность приложений/07 SQL и NoSQL/04 NoSQL injection#Умный метод - битовый подбор по ASCII|Умный метод - битовый подбор по ASCII]]
