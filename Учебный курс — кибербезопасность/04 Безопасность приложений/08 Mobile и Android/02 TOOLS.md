...
![[Учебный курс — кибербезопасность/10 Справочники/01 Каталог инструментов#Декомпиляторы для программ на Java и под Android|Инструментарий для анализа Android-приложений]]
