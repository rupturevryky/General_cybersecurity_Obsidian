...
verified_against: https://github.com/fortra/impacket
---

> [!note] Проверено для Impacket 0.13.1
> Официальный репозиторий теперь находится в организации Fortra. Для стабильной установки разработчики рекомендуют `pipx`; запуск `setup.py install` устарел.
...
этот же сервер можно использовать совместно с [[Учебный курс — кибербезопасность/05 Сетевая безопасность/Техники сетевого тестирования/07 mitm6|mitm6]], чтобы красть аутентификационные данные пользователей.
...
![[Учебный курс — кибербезопасность/05 Сетевая безопасность/Active Directory/Инструменты/assets/Pasted image 20240531151613.png]]
...
```
![[Учебный курс — кибербезопасность/05 Сетевая безопасность/Active Directory/Инструменты/assets/Pasted image 20240531152547.png]]
