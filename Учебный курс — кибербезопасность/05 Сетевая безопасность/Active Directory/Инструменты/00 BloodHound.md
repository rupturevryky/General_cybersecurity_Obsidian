...
verified_against: https://bloodhound.specterops.io/get-started/quickstart/community-edition-quickstart
---

> [!note] BloodHound CE и коллектор — разные компоненты
> `bloodhound-python` — сторонний коллектор, а современный BloodHound CE разворачивается отдельно. Legacy GUI через `neo4j start` не является актуальным quickstart.
