...
verified_against: https://docs.metasploit.com/docs/using-metasploit/basics/using-metasploit.html
---

> [!warning] Только изолированный стенд
> Имена модулей и параметры сверяйте через `info`, `show options` и `show advanced`. Не переносите payload-файлы из лаборатории.
