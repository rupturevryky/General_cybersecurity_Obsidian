...
verified_against: https://scapy.readthedocs.io/en/latest/usage.html
---
# Scapy


> [!warning] Пересылка пакетов меняет систему
> Используйте `sudo sysctl -w net.ipv4.ip_forward=1`, сохраните исходное значение и восстановите его после лаборатории.
...
# После лаборатории восстановите исходное значение, обычно:
